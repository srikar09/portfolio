...
public class clientmain2 extends Application {
    ...
    public void start(Stage primaryStage)  {    
    	...
    	try {
			...
			rightHereMap.put("Smith",io);	 //smith center
       ...
       top.setPrefSize(800, 50);
        ...
        Label label1 = new Label("James to Srikar");
        ...
        sendLeft.setOnAction(e->{
        	String message=
                	io4.getText();
        	 io1.appendText("\n"+this.name+" :"+message);
         String output =  "James"+ "%;&"+"Srikar"+"%;&"+"Yes"+"%;&"+message;
        ...
        sendRight.setOnAction(e->{
          ...
          //  io3.appendText("\n"+this.name+" :"+message);
            String output =  "James"+"%;&"+"Smith"+"%;&"+"no"+"%;&"+message;
            outputStream.println(output);
            outputStream.flush(); 
        ...
        SendMiddle.setOnAction(e->{
            ...
            System.out.println(message);
            io.appendText("\n"+this.name+" :"+message);
            String output =  "James"+"%;&"+"Smith"+"%;&"+"Yes"+"%;&"+message;
            outputStream.println(output);
            outputStream.flush(); 
