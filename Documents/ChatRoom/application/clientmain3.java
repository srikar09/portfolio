...
public class clientmain3 extends Application {
	...
	public static TextArea io = new TextArea(); //center
    public static TextArea io1 =new TextArea();   //left 
    public static   TextArea io3 =new TextArea();  //Right
    ...
    public void start(Stage primaryStage)  {    
    	...
    	try {
			...
			rightHereMap.put( "Srikar",io1); // Srikar left
			rightHereMap.put("James",io);  // James Center
			rightHereMap.put("no",io3); //all Right
       ...
       top.setPrefSize(800, 50);
        ...
        Label label1 = new Label("James- Srikar");
        ...
        Button sendLeft =new Button("Talk to Srikar");
        Button sendRight =new Button("GroupChat");
        Button SendMiddle =new Button("Talk to James");
        ...
        sendLeft.setOnAction(e->{
        	String message=
                	io4.getText();
        	 io1.appendText("\n"+this.name+" :"+message);
         String output =  "Smith"+ "%;&"+"Srikar"+"%;&"+"Yes"+"%;&"+message;
        ...
        sendRight.setOnAction(e->{
         ...
         //   io3.appendText("\n"+this.name+" :"+message);
            String output =  "Smith"+"%;&"+"jklm"+"%;&"+"no"+"%;&"+message;
            outputStream.println(output);
            outputStream.flush(); 
        ...
        SendMiddle.setOnAction(e->{
            ...
            System.out.println(message);
            io.appendText("\n"+this.name+" :"+message);
            String output =  "Smith"+"%;&"+"James"+"%;&"+"Yes"+"%;&"+message;
            outputStream.println(output);
            outputStream.flush(); 
